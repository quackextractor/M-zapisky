...
| **Příslovečné určení (PU)** | Rozvíjí sloveso, přídavné jméno nebo příslovce. | Kde/Kam/Odkud? (**PUm** pro místo)
Kdy/Odkdy? (**PUč** pro čas)
Jak/Jakým způsobem? (**PUz** pro způsob)
Jak moc/Do jaké míry? (**PUmí** pro míru)
Proč/Z jaké příčiny? (**PUpř** pro příčinu)
Za jakým účelem? (**PUú** pro účel)
Za jaké podmínky? (**PUpod** pro podmínku)
I přes co/Navzdory čemu? (**PUpříp** pro přípustku) | Šel **domů**.
Přišel **včera**.
Mluvil **tiše**.
Byl **velmi** rád. |
