...
|---|---|---|
| **Prostěsdělovací** | Běžná komunikace, zprávy, omluvy. | Rychle předat běžnou informaci. |
| **Odborný** | Učebnice, encyklopedie, vědecké články. | Přesně a objektivně poučit, využívá termíny. |
| **Administrativní** | Žádosti, formuláře, vyhlášky. | Úřední styk, strohý, bez emocí. |
| **Publicistický** | Novinové články, reportáže, komentáře. | Informovat veřejnost, přesvědčit nebo zaujmout. |
| **Umělecký** | Básně, romány, povídky. | Estetický zážitek, vyvolat emoce, obrazná pojmenování. |
| **Řečnický** | Slavnostní projevy, proslovy, kázání, debaty. | Přesvědčit posluchače, navázat kontakt, bezprostředně zapůsobit. |

### Slohové postupy (Jak text stavíme)
| Postup | Charakteristika |
|---|---|
| **Informační** | Jen suše podává fakta (Kdo, co, kdy, kde). |
| **Vyprávěcí** | Děj, který má zápletku a posouvá se v čase. |
...
### Klíč k řešení (Téma 1)
 ...
 2. **Administrativní styl**, informační postup.
 3. **Umělecký styl**, vyprávěcí postup.
 4. **Publicistický styl** (případně řečnický), úvahový postup.
 5. **Prostěsdělovací styl**, informační postup.
 6. **Administrativní styl**, informační postup.
 7. **Umělecký styl**, popisný postup.
...
| Typ věty | Definice |
|---|---|
| **Věta hlavní (VH)** | Dává smysl sama o sobě. Nelze se na ni zeptat jinou větou v souvětí. |
| **Věta vedlejší (VV)** | Nedává sama o sobě úplný smysl. Zastupuje větný člen věty hlavní a začíná spojovacím výrazem (když, že, aby, protože, který, jenž). Na větu vedlejší se ptáme větou hlavní. |

### Poměry mezi hlavními větami (Souřadné spojení)
Pokud jsou vedle sebe dvě věty hlavní, jsou v tzv. souřadném poměru. Nezávisí na sobě, obě dávají smysl samy o sobě, ale spojuje je určitý logický vztah.

| Typ poměru | Charakteristika vztahu | Nejčastější spojky | Příklad |
|---|---|---|---|
| **Slučovací** | Věty jsou prostě přiřazeny k sobě, obsahy platí současně nebo jdou po sobě. | a, i, ani, nebo, též, pak, potom | Přišel domů **a** lehl si. |
| **Odporovací** | Obsahy vět si odporují nebo se omezují. (Před spojkou píšeme čárku). | ale, avšak, však, nýbrž, naopak, sice - ale | Slíbil to, **ale** nepřišel. |
| **Vylučovací** | Obsahy vět se vzájemně vylučují, platí jen jedna možnost. | nebo, anebo, buď - nebo, buď - anebo | **Buď** přijdeš, **nebo** zavoláš. |
| **Stupňovací** | Druhá věta stupňuje, zesiluje význam první věty. | ba, ba i, dokonce, nejen - ale i | Neslyšel to, **dokonce** ani neviděl. |
| **Příčinný (důvodový)** | Druhá věta vyjadřuje příčinu (důvod) toho, co se říká v první větě. | neboť, vždyť, totiž | Zůstal doma, **neboť** byl nemocný. |
| **Důsledkový** | Druhá věta vyjadřuje důsledek toho, co se říká v první větě. | proto, a proto, a tak, tudíž, tedy | Byl nemocný, **a proto** zůstal doma. |

### Typy vedlejších vět
| Typ věty | Jak se ptáme | Příklad |
|---|---|---|
| **Podmětná** | Kdo, co? | Kdo lže, ten krade. (Kdo krade? Ten, kdo lže.) |
| **Přísudková** | Jaký je (podmět)? | Obloha byla, jako by ji vymetl. |
| **Předmětná** | Pádové otázky kromě 1. a 5. pádu. | Řekl mi, že nepřijde. (Koho, co mi řekl? Že nepřijde.) |
| **Přívlastková** | Jaký, který, čí? | Dům, který jsme koupili, je starý. (Jaký dům? Který jsme koupili.) |
| **Doplňková** | Jak, jaký, jako co? | Sledoval jsem ho, jak potichu odchází. |
| **Příslovečná místní** | Kde, kam, odkud? | Půjdeme tam, kam nás nohy zanesou. |
| **Příslovečná časová** | Kdy, jak dlouho? | Když prší, zůstávám doma. |
| **Příslovečná způsobová** | Jak, jakým způsobem? | Udělal to tak, jak mu poradili. |
| **Příslovečná měrová** | Jak moc, do jaké míry? | Foukal tak silný vítr, až se stromy prohýbaly k zemi. |
| **Příslovečná příčinná** | Proč? | Nepřišel, protože byl nemocný. |
| **Příslovečná účelová** | Za jakým účelem? | Pilně studoval, aby uspěl u přijímacích zkoušek. |
| **Příslovečná podmínková** | Za jaké podmínky? | Jestliže zítra nezaprší, celá úroda uschne. |
| **Příslovečná přípustková** | I přes co, navzdory čemu? | Ačkoli byl silně unavený, dokončil svou práci včas. |

### Jak postupovat při rozboru
 1. Podtrhni si všechna určitá slovesa. Kolik je sloves, tolik je vět.
 2. Najdi spojovací výrazy (že, protože, když). Věta za spojkou je vedlejší (VV).
 3. Věta bez spojovacího výrazu je hlavní (VH).
 4. Pomocí věty hlavní se zeptej na větu vedlejší a urči její typ.
 5. Pokud jsou v souvětí dvě hlavní věty vedle sebe, urči jejich významový poměr podle spojky.

### Vyřešené příklady
**Příklad 1:** Myslím, že dnes bude pršet.
 * **Slovesa:** myslím, bude pršet (2 věty).
...
### Příklady na procvičení
 ...
 2. Až dopíšeš ten dopis, půjdeme se projít.
 3. Kdo se bojí, nesmí do lesa.
 4. Auto, které stálo před domem, patřilo našemu sousedovi.
 5. Nevěděl jsem, kam mám jít dál.
 6. Protože zaspal, nestihl ranní vlak.
 7. Všichni se chovali tak, jak se od nich očekávalo.
 8. Město, ve kterém jsem se narodil, se hodně změnilo.
 9. Je nutné, abychom tam dorazili včas.
 10. Vrátil se na místo, kde ztratil klíče.
 11. Otevřel jsem knihu a začal jsem si potichu číst.
 12. Chtěl jsem jít včera do kina, avšak nesehnal jsem už žádné lístky.
 13. Buď se do toho pustíme hned, nebo to už nikdy nedokončíme.
...
### Klíč k řešení (Téma 2)
 ...
 2.    1. VV **příslovečná časová** (Kdy se půjdeme projít?), 2. VH.
 3.    1. VV **podmětná** (Kdo nesmí do lesa?), 2. VH.
 4. 1a. VH, 2. VV **přívlastková** (Jaké auto?), 1b. VH.
 5.    1. VH, 2. VV **předmětná** (Koho, co jsem nevěděl?).
 6.    1. VV **příslovečná příčinná** (Proč nestihl vlak?), 2. VH.
 7.    1. VH, 2. VV **příslovečná způsobová** (Jak se chovali?).
 8. 1a. VH, 2. VV **přívlastková** (Jaké město?), 1b. VH.
 9.    1. VH, 2. VV **podmětná** (Kdo, co je nutné?).
 10.    1. VH, 2. VV **přívlastková** (Na jaké místo?).
 11.    1. VH, 2. VH. Poměr **slučovací**.
 12.    1. VH, 2. VH. Poměr **odporovací**.
 13.    1. VH, 2. VH. Poměr **vylučovací**.
...
| Větný člen | Otázka a funkce | Příklad |
|---|---|---|
| **Přísudek (Př)** | Co dělá podmět? Co se o něm říká? (Většinou sloveso) | Běhá, čte, je chytrý. |
| **Podmět (Po)** | Kdo, co to dělá? (Základní případ je 1. pád) | **Pes** štěká. |
...
| Druh PU | Značka | Otázka | Příklad |
|---|---|---|---|
| **Místa** | PUm | Kde? Kam? Odkud? Kudy? | Šel **domů**. Šel **lesem**. |
| **Času** | PUč | Kdy? Odkdy? Dokdy? Jak dlouho? | Přišel **včera**. Spal **dlouho**. |
| **Způsobu** | PUz | Jak? Jakým způsobem? | Mluvil **tiše**. Zpíval **krásně**. |
| **Míry** | PUmí | Jak moc? Do jaké míry? | Byl **velmi** rád. **Zcela** souhlasil. |
| **Příčiny** | PUpř | Proč? Z jaké příčiny? | Plakal **bolestí**. Nešel tam **kvůli nemoci**. |
| **Účelu** | PUú | Za jakým účelem? K čemu? | Jel tam **na nákup**. Lék **proti bolesti**. |
 ...
 * došel: Přísudek (Př)
 * závodník: Podmět (Po)
 * Navzdory dešti: I přes co došel? Příslovečné určení přípustky (PUpříp)
 * silnému: Jakému dešti? Přívlastek shodný (Pks)
 ...
 * Chlapec: Podmět (Po)
 * zimou: Proč se třásl (z jaké příčiny)? Příslovečné určení příčiny (PUpř)
...
### Příklady na procvičení
 ...
 11. Dívka zčervenala studem, když ji učitel vyvolal. (Urči slovo "studem")
 12. Maminka jela do města na nákup vánočních dárků. (Urči spojení "na nákup")
...
### Klíč k řešení (Téma 3)
 ...
 11. **studem** = Proč zčervenala (příčina)? **PUpř** (příčiny).
 12. **na nákup** = Za jakým účelem jela? **PUú** (účelu).
