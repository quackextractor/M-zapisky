...
### ČÁST A: [Doplňte název první knihy]
...
* **Závěr:** Jak kniha končí? **(Určete, zda je závěr tragický, a jasně definujte, zda je otevřený, nebo uzavřený).**
...
* **Hlavní postava (postavy):** Jméno, povahové rysy a **jak přesně se vyvíjejí v průběhu příběhu (jejich psychologický vývoj).**
...
### ČÁST B: [Doplňte název druhé knihy]
...
*(Zahrnuje: Analýzu druhého textu, **která musí být konkrétně rozpracována do následujících bodů:**)*
...
* Je důležité porozumět všem termínům, ať už jsou to názvy druhů, žánrů a forem, nebo klíčové výrazy specifické pro vnitřní i obecný obsah díla. Zde je prostě nutné **vypsat všechny dříve jmenované termíny a uvést jejich velice stručné, ale výstižné definice.**